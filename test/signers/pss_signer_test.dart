...
void main() {
  ...
  var slt2a = hex.decode('57bf160bcb02bb1dc7280cf0458530b7d2832ff7');
  var sig2a = hex.decode(
  ...
  var slt2b = hex.decode('7f6dd359e604e60870e898e47b19bf2e5a7b2a90');
  var sig2b = hex.decode(
  ...
  // PSS Example 4.1
  var msg4a = hex.decode('9fb03b827c8217d9');

  var slt4a = hex.decode('ed7c98c95f30974fbe4fbddcf0f28d6021c0e91d');

  var sig4a = hex.decode(
  ...
  var slt4b = hex.decode('22d71d54363a4217aa55113f059b3384e3e57e44');

  var sig4b = hex.decode(
  ...
  var slt8a = hex.decode('1d65491d79c864b373009be6f6f2467bac4c78fa');
  var sig8a = hex.decode(
  ...
  // PSS Example 8.2
  var msg8b = hex.decode(
      'e2f96eaf0e05e7ba326ecca0ba7fd2f7c02356f3cede9d0faabf4fcc8e60a973e5595fd9ea08');
  var slt8b = hex.decode('435c098aa9909eb2377f1248b091b68987ff1838');
  var sig8b = hex.decode(
  ...
  var slt9a = hex.decode('c0a425313df8d7564bd2434d311523d5257eed80');
  var sig9a = hex.decode(
