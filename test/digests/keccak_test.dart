...
var _truncKey = new KeyParameter(
...
var _xtremeData = createUint8ListFromHexString(
...
void testKeccakAgainstVectors() {
  group("Keccak Digest", () {
    exerciseDigest(new KeccakDigest(), _digests288);
    exerciseDigest(new KeccakDigest(224), _digests224);
    exerciseDigest(new KeccakDigest(288), _digests288);
    exerciseDigest(new KeccakDigest(256), _digests256);
    exerciseDigest(new KeccakDigest(384), _digests384);
    exerciseDigest(new KeccakDigest(512), _digests512);
  });

  group("Keccak Hmac", () {
    exerciseKeccakMac(
        new KeccakDigest(224), _macKeys, _macData, _mac224, _trunc224);
    exerciseKeccakMac(
        new KeccakDigest(256), _macKeys, _macData, _mac256, _trunc256);
    exerciseKeccakMac(
        new KeccakDigest(384), _macKeys, _macData, _mac384, _trunc384);
    exerciseKeccakMac(
        new KeccakDigest(512), _macKeys, _macData, _mac512, _trunc512);
  });
}
