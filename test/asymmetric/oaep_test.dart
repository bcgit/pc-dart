...
class Vector {
  ...
  RSAPublicKey getPublicKey() {
    return new RSAPublicKey(pubMod, pubExp);
  }

  RSAPrivateKey getPrivateKey() {
    return new RSAPrivateKey(privMod, privExp, privP, privQ);
  }
}
...
void rsaesOaepFromBC() {
  ...
  test("RSAESOAEP decryption vectors from BC", () {
    vectors.forEach((Vector v) {
      ...
      rsaesOaep.init(
          false, new PrivateKeyParameter<RSAPrivateKey>(v.getPrivateKey()));
  ...
  test("RSAESOAEP encryption vectors from BC", () {
    vectors.forEach((Vector v) {
      ...
      rsaesOaep.init(
          true,
          ParametersWithRandom(
              new PublicKeyParameter<RSAPublicKey>(v.getPublicKey()), rng));
